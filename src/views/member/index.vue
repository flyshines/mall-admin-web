  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="productTable"
        ...
        <el-table-column label="成员编号" width="120" align="center">
          <template slot-scope="scope">{{scope.row.id}}</template>
        </el-table-column>
        <el-table-column label="成员头图" width="140" align="center">
          <template slot-scope="scope"><img style="height: 80px" :src="scope.row.image"></template>
        </el-table-column>
        <el-table-column label="成员名称" width="140" align="center">
        ...
        <el-table-column label="时间"  width="120" align="center">
          <template slot-scope="scope">{{scope.row.workStart}} ~ {{scope.row.workEnd}}</template>
        </el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleAddMember(){
        this.$router.push({path: '/member/addMemberDetail'})
      },
